<div class="navbar">
    <div class="navbar-inner">
      <div class="container" style="width: auto;">
        ...
        <?= $this->tag->linkTo([null, 'class' => 'brand', 'Tracker']) ?>
        <div class="nav-collapse">
          <ul class="nav"><?php $menus = ['Home' => 'index', 'Display Records' => 'record']; ?><?php foreach ($menus as $key => $value) { ?>
          ...
          <ul class="nav pull-right"><?php if (!(empty($logged_in))) { ?>
            <li><?= $this->tag->linkTo(['user', $username]) ?></li>
